...
Wearing normal clothes - a tee and shorts. No mask or anything. Sandy hair.`),
  new Post("nav", "test", `Lmao, that’s gotta be the same kid who shut down Concrete Jack a few weeks ago.`),
  new Post("wbc", "test", `Wait, he took down Concrete Jack? That dude’s built like a fridge. Thought he dipped after the Dust Hounds broke up?
What's his power again?`),
  new Post("nav", "test", `Nah, he’s back, was just rolling solo till now. Got that weight-lock power—stands still too long and turns into a walking wrecking ball. He was trying to bust into a pawn shop, and the cops couldn’t do jack (LOL). Dude was literally walking through their barricade.
...
Also, idk if it was just the video, but the kid’s arm stretched a little when he grabbed Jack. Not full noodle mode, but something.I think he’s got some kind of super strength. Heard he was a [UC] before, but I dunno if that’s true. He’s been around for a while, though. Just never really did anything until now.`),
  new Post("wbc", "test", `Lmfao, so this kid just outmuscled Concrete Jack? And might be stretchy?? That’s some S-tier energy for a UC right there.

Wonder why he’s dipping so fast, though. No quip, no posing, no name drop, just poof.`),
  new Post("cf2", "test", `Could be he’s just starting out. No costume, no name, maybe doesn’t even know what he’s doing yet. If he’s really that young, he might not even be a proper hero—just a kid with powers testing the waters.

Or maybe he’s trying to stay lowkey and not get scooped up by the big leagues. Lotta young capes get picked up fast.`),
  new Post("nav", "test", `Yeah, if he keeps this up, someone’s slapping a label on him. Either the media or some A-list cape trying to “mentor” him. Kid better at least grab a ski mask or something.
...
Grip (simple, effective)`),
  new Post("wbc", "test", `Not “Kid Titan,” that sounds like a knockoff brand. I kinda like Grip, tbh.
